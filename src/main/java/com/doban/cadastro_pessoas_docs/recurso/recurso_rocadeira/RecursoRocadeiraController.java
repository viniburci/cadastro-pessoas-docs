...
public class RecursoRocadeiraController {
    ...
    @PostMapping
    public ResponseEntity<RecursoRocadeiraResponseDTO> criar(@RequestBody RecursoRocadeiraRequestDTO dto) {
        return ResponseEntity.ok().body(service.criar(dto));
    }

    @PutMapping("/{id}/devolucao")
    public ResponseEntity<RecursoRocadeiraResponseDTO> registrarDevolucao(@PathVariable Long id, @RequestBody DevolucaoDTO dto) {
